          ...
          >
            ...
            <div className="flex items-center mb-4">
              ...
              <input
                ...
                className="w-full p-2 border border-gray-500 rounded-md focus:outline-none focus:border-primary sm:text-sm"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-primary text-white py-2 px-4 hover:bg-secordary text-sm transition duration-500"
            >
