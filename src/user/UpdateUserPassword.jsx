...
const UpdateUserPassword = () =>{
    ...
    return(
        ...
        {loading ? <Loader /> :
          ...
          <div className="flex flex-col items-center justify-center sm:min-h-screen h-[35rem]">
          ...
          <div className="signup-form">
                  ...
                  <div className="mb-8 relative">
                      ...
                      <input
                        ...
                        className="w-full p-2 px-8 border font-serif border-gray-400 rounded-sm focus:outline-none focus:border-primary"
