...
const TreksCart = () => {
  ...
  return (
   ...
   <h1 className="text-lg font-bold uppercase">Trecks <span className='flex flex-col border-b-2 border-orange-500 w-8'></span> </h1>
          ...
          <div className="bg-white rounded-lg shadow-xl border transition duration-300 cursor-pointer">
            ...
            <div className="flex items-center text-xs justify-between h-8">
              ...
              <div className="flex justify-between items-center mt-2 gap-4">
                ...
                <a href='/' className="bg-primary hover:bg-orange-600 font-semibold text-white px-4 py-2 rounded-md text-sm w-full m-auto text-center">
                  Avail This Offer
                </a>
              </div>
            </div>
