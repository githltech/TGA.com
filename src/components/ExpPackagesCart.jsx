...
const ExpPackagesCart = () => {
  ...
  return (
   ...
   <h1 className="text-lg font-bold uppercase">Experience Packages <span className='flex flex-col border-b-2 border-orange-500 w-20'></span> </h1>
...
export default ExpPackagesCart;
