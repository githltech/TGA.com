...
const EventsCart = () => {
  ...
  const cardData = [
    {
      ...
      images: [
        'https://media1.thrillophilia.com/filestore/94bvlf0n4ndowsznjczdjjtvqpw2_shutterstock_1751658116.jpg?w=340&dpr=2',
    ...
    },
    {
      ...
      images: [
        'https://media1.thrillophilia.com/filestore/mi1hujt87wfa8b41pmxmpy8e713q_shutterstock_2446462209.jpg?w=340&dpr=2',
...

    {
        ...
        title: 'Discovering Dubai | A Journey To The Golden Emirates',
        images: [
          'https://media1.thrillophilia.com/filestore/wkmaue5fr7xvy2jqz0yp6fxkuehj_shutterstock_474346684.jpg?w=340&dpr=2',
  ...
  return (
   ...
   <h1 className="text-lg font-bold uppercase">Events <span className='flex flex-col border-b-2 border-orange-500 w-10'></span> </h1>
          ...
          <div className="bg-white rounded-lg shadow-xl border transition duration-300 cursor-pointer">
            ...
            <div className="flex items-center text-xs justify-between h-8">
              ...
              <div className="flex justify-between items-center mt-2 gap-4">
                ...
                <a href='/' className="bg-orange-500 hover:bg-orange-600 font-semibold text-white px-4 py-2 rounded-md text-sm w-full m-auto text-center">
                  Avail This Offer
                </a>
              </div>
            </div>
