...
const AccomodationCart = () => {
  ...
  const cardData = [
    {
      ...
      images: [
        'https://media1.thrillophilia.com/filestore/ow16k8n3gykav9x3vop581fi9c68_shutterstock_1308414568.jpg?w=340&dpr=2',
    ...
    },
    {
      ...
      images: [
        'https://media1.thrillophilia.com/filestore/9aqntxyexpidf1e454kfgvgtl734_shutterstock_529323232%20(1).jpg?w=340&dpr=2',
  ...
  return (
    <div className="relative w-full py-6 px-4 lg:px-20">
     ...
     <h1 className="text-lg font-bold uppercase">Acoomodation <span className='flex flex-col border-b-2 border-primary w-20'></span> </h1>
