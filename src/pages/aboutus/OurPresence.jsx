    ...
    <div className="py-16 px-4 md:px-16 lg:px-24 bg-white">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-12">
        ...
        <div className="text-center">
          ...
          />
          <h3 className="text-[#202020] text-[22px] font-medium ">Jaipur, India</h3>
        ...
        <div className="text-center">
          <img
            ...
            className="w-20 h-20 mx-auto mb-6"
          />
          <h3 className="text-[#202020] text-[22px] font-medium ">Dubai, UAE</h3>
          <p className="text-gray-500 text-sm">
        ...
        <div className="text-center">
          <img
            ...
            className="w-20 h-20 mx-auto mb-6"
          />
          <h3 className="text-[#202020] text-[22px] font-medium ">Delaware, USA</h3>
          <p className="text-gray-500 text-sm">
